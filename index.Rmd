...
`RGset` we use [**minfi**](http:/bioconductor.org/packages/minfi) but
**DNAmArray** provides functionality to do this in
parallel. Furthermore, we have developed two other packages
[**MethylAid**](http:/bioconductor.org/packages/MethylAid) [@Iterson2014] and
[**bacon**](http:/bioconductor.org/packages/bacon) [@Iterson2017], reps.,
