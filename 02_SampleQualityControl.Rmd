...
load("/exports/molepi/users/ljsinke/DNAmArray/DNAmArray_workflow/data/targets_mod.RData")
```
...
RGset <- read.metharray.exp.par(base="../GSE113018/IDATs", targets, verbose=FALSE, extended=TRUE)
```
...
```{r 213omicsprint, message=FALSE, warning=FALSE}
library(omicsPrint)
