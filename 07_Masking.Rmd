...
Having a `RangedSummarizedExperiment` class object expedites masking sex chromosomal probes. It is important in most EWAS analyses to remove these as failing to do so can confound inferences. 
