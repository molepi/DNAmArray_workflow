...
distribution can be plotted. For exmaple, using `densityPlot` from
...
> converts them to beta-values using M/(M+U), whereas,
...
dendrogram. However, this might be more appropriated for data sets
with moderated sample sizes. Although, the
...
Highlighting a suspected outlyer can be convenient.
