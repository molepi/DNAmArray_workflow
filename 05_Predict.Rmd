...
```{r 606agep, message=FALSE, warning=FALSE}
library(wateRmelon)
data(hannumCoef)
...
![](C:/Users/ljsinke/Documents/git/GitHub/DNAmArray_workflow/06_Predict_files/figure-html/corrplots.png)
