...
We assume the data has been normalized, filtered and NA's have been imputed. Furthermore, it is very convenient to construct a `SummarizedExperiment`-object as described in the previous section.

For example, the model that you would like to run can be added like this with the first covariate the phenotype of interest.
